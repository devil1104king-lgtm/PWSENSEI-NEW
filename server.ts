...
// Secret admin entry — public pages do NOT show Admin Portal link
// Open admin: https://your-domain.com/TheSK08
app.get('/TheSK08', (req, res) => {
...
// Keep /admin working for logged-in sessions (not linked on public site)
